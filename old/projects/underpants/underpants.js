...
_.filter = (arr, fun) => {
    ...
    // let trues = [];
    // trues.push(_.each(arr, (x, y, z) => { if(fun(x,y,z)) { return x; } }));
    // return trues;
};
...
_.contains = (arr, val) => {
    ...
    return (_.indexOf(arr, val) !== -1 && val) ? true : false;
